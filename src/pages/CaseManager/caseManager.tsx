                ...
                <Paper elevation={3} sx={{ padding: 2, marginBottom: 2, border: '1px solid #d3d3d3' }}>
                    <Grid container spacing={2}>
                        <Grid item xs={6}>
                            ...
                            >
                                <Button variant="outlined" size="small" sx={{ whiteSpace: "normal" }} onClick={fetchAll}>
                                    All
                                </Button>
                                <Button variant="outlined" size="small" sx={{ whiteSpace: "normal" }} onClick={fetchUnassigned}>
                                    Unassigned
                                </Button>
                                <Button
                                    variant="outlined"
