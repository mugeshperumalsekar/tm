            ...
            <div>
              <div className="table-responsive" style={{ marginLeft: '-6%', marginRight: '-5%' }}>
                ...
                {showPendingRIFTable && (
                  <>
                    {showBulkTaskAssignView ? (
                      ...
                      <TableContainer component={Card} sx={{ maxHeight: { xs: "250px", sm: "280px", md: "300px", lg: "320px", xl: "700px" }, overflow: "auto", }}>
                ...
                {showPendingCaseTable && (
                  <>
                    <TableContainer component={Card} style={{ maxHeight: '320px', overflowY: 'auto' }}>
                      <Table size="small" aria-label="a dense table" style={{ minWidth: '600px' }}>
                        <TableHead >
                          <TableRow>
                            <TableCell className="MuiTableCell-head">S.No</TableCell>
